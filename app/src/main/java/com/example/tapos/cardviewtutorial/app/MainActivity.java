...
import static com.example.tapos.cardviewtutorial.R.id.toolbar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(null);
        toolber = (Toolbar)findViewById(toolbar);
...
//                        fragmentTransaction.commit();
        ...
        ActionBarDrawerToggle actionBarDrawerToggle = new ActionBarDrawerToggle(this,drawerLayout,toolber,R.string.openDrawer, R.string.closeDrawer){
